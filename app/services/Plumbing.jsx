import { DrawerLayoutAndroid, Image, Text, View, TouchableOpacity, TextInput, KeyboardAvoidingView, ScrollView, Platform, ImageBackground } from "react-native";
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
                <View className="flex-1 flex-wrap items-center justify-between pb-10">
                    ...
                    <View style={{ width: wp(100) }} className="flex-col items-start justify-start">
                        <ImageBackground style={{ height: hp(35) }} className="w-full" source={require('../../assets/images/Plumbing Services.png')}>
                            
                        {/* Back Navigation */}
                            <SafeAreaView>
                                <TouchableOpacity onPress={() => router.back()} style={{ paddingLeft: 25, paddingTop: 15 }}>
